...
| "relation X does not exist" (dashboard/ruta) | jesi li pokrenuo init-db nakon deploya sheme? | v013+ faza sa shemom → `…/api/init-db?key=…` JEDNOM; ruta pada na prvom upitu pa skriva i ostale podatke (npr. listu korisnika) |
