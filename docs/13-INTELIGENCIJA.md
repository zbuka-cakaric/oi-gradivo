...
## CHANGELOG
- 1.3 (2026-07-05): **v062 — SRS (spaced repetition, Leitner)**: pogreške iz testova/ponavljanja se vraćaju u razmacima 1·3·7·14·30 dana (box 1-5). Kriv odgovor bilo gdje → box1; točan u ponavljanju → box+1. Jezgra dugoročnog pamćenja gradiva; besplatno (magnet za studente). Sljedeće: F9 plan (tempo do ispita) veže SRS due + spremnost.
...
## DOPUNA 2026-07-09
Raščlamba potrošnje po značajkama (v176) daje podatkovnu osnovu za buduće uvide o korištenju; tier_postavke omogućuju eksperimente s kvotama bez deploya.
